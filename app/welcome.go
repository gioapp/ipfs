...
func (g *GioIPFS) welcomeBody() []func(gtx C) D {
	return []func(gtx C) D{
		func(gtx C) D {
			return lyt.Format(gtx, "hflexb(start,f(0.62,inset(0dp0dp0dp16dp,_)),f(0.38,inset(0dp0dp0dp16dp,_)))",
				ContainerLayout(g.UI.Theme.Colors["PanelBg"], 10, 10, 10, 10, func(gtx C) D {
					gtx.Constraints.Min.X = gtx.Constraints.Max.X
